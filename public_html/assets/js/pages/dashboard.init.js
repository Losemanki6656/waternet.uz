...
(chart = new ApexCharts(document.querySelector("#mini-chart2"), options)).render(), ChartColorChange(chart, "#mini-chart2");
options = {
    series: [65, 45],
    chart: {
        type: "donut",
...
(chart = new ApexCharts(document.querySelector("#mini-chart3"), options)).render(), ChartColorChange(chart, "#mini-chart3");
options = {
    series: [30, 70],
    chart: {
        type: "donut",
...
(chart = new ApexCharts(document.querySelector("#mini-chart4"), options)).render(), ChartColorChange(chart, "#mini-chart4");
options = {
    series: [{
        name: "Profit",
