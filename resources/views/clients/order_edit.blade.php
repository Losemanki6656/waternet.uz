                        ...
                        <tbody>
                            ...
                            @foreach ($orders as $order)
                                <tr>
                                    ...
                                    <td>{{ $order->client->city->name ?? '' }}, {{ $order->client->area->name ?? '' }},
                                        {{ $order->client->address ?? '' }}</td>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-dark" data-toggle="modal"
                                            data-target="#edit{{ $order->id }}"><i class="fa fa-edit"></i></button>
                                    </td>
                                </tr>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-4 col-md-6">
                                                                ...
                                                                <input class="form-control" type="number"
                                                                    ...
                                                                    id="count{{ $order->id }}" value="0" required>
                                                            </div>
                                                            <div class="col-lg-4 col-md-6">
