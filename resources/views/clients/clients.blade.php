                ...
                <div class="row clearfix">
                    <div class="col-lg-3 col-md-6">
                        <div class="input-group mb-3">
                            <select class="form-control show-tick select2" id="sity_select" name="city_id"
                                data-placeholder="Regionni tanlang" required>
                                <option value=""></option>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="input-group mb-3">
                            <select class="form-control show-tick select2" id="area_select" name="area_id"
                                data-placeholder="Shaharni tanlang" required>
                                <option value=""></option>
                        ...
                        <form action="{{ route('clients') }}" method="get">
                            ...
                            <div class="input-group mb-3">
                                <input class="form-control" value="{{ request()->query('search') }}" name="search"
                                    type="search" id="search" placeholder="Qidirish ..." aria-label="Search" />
                            </div>
                        </form>
                    </div>
                </div>
            ...
            @push('scripts')
                <script>
                    $('#sity_select').change(function(e) {
                        ...
                        window.location.href = `${url}?paginate=${paginate}&city_id=${city_id}`;
                    })
                    ...
                    $('#area_select').change(function(e) {
                        ...
                        let paginate = $('#select_paginate').val();
                        let url = '{{ route('clients') }}';
                        window.location.href = `${url}?paginate=${paginate}&city_id=${city_id}&area_id=${area_id}`;
                    })
                </script>
            @endpush
                    ...
                    <table class="table mb-0 table-bordered">
                        ...
                        <tbody>
                            ...
                            @foreach ($clients as $client)
                                    ...
                                    <td class="text-center">
                                        @if ($client->location != '0')
                                            <a type="button" target="_blank"
                                                ...
                                                title="Lokatsiyasi" class="btn btn-warning">
                                                <i class="fa fa-map-marker"></i> <span></span></a>
                                        @else
                                            <button type="button" class="btn btn-outline-warning" title="Lokatsiyasi"
                                                disabled>
                                                <i class="fa fa-map-marker"></i> <span></span></button>
                                        @endif
                                        <button type="button" class="btn btn-danger"
                                            data-target="#order{{ $client->id }}" data-toggle="modal"
                                            data-placement="bottom" title="Zakas olish">
                                            <i class="fa fa-shopping-cart"></i> <span></span></button>

                                        <button type="button" class="btn btn-success" data-toggle="modal"
                                            title="Pul qo'shish" data-target="#clietnprice{{ $client->id }}">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="javascript:void(0);"
                                                style="color: rgb(255, 168, 7)" data-toggle="modal"
                                                data-target="#container{{ $client->id }}"><i
                                                    class="fa fa-download"></i> Idish qaytarish</a>
                                            <a class="dropdown-item"
                                                href="{{ route('soldproducts', ['id' => $client->id]) }}"
                                                style="color: rgb(0,123,255)"><i class="fa fa-cube"></i> Xisobot</a>
                                            <a class="dropdown-item" href="javascript:void(0);" data-toggle="modal"
                                                data-target="#edit{{ $client->id }}"><i class="fa fa-edit"></i>
                                                Taxrirlash</a>
                                            <a class="dropdown-item" href="javascript:void(0);" data-toggle="modal"
                                                data-target="#delclient{{ $client->id }}"
                                                style="color: rgb(220,53,69)"><i class="fa fa-trash"></i> O'chirish</a>
                                        </div>
                                    </td>
                                </tr>
                                <div class="modal fade" id="container{{ $client->id }}" tabindex="-1"
                                    role="dialog">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ route('client_container', ['id' => $client->id]) }}"
                                                method="post">
                                                @csrf
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="product_id" id="tolov-usuli"
                                                            required>
                                                ...
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control show-tick select2"
                                                            id="prod_sel{{ $client->id }}" name="product_id"
                                                            onchange="onsel({{ $client->id }})" required>
                                                            @foreach ($products as $product)
                                ...
                                <div class="modal fade" id="clietnprice{{ $client->id }}" tabindex="-1"
                                    role="dialog">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <form action="{{ route('client_price', ['id' => $client->id]) }}"
                                                method="post">
                                                @csrf
                                                <div class="modal-body">
                                ...
                                <div class="modal fade" id="edit{{ $client->id }}" tabindex="-1" role="dialog">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ route('client_edit', ['id' => $client->id]) }}"
                                                method="post">
                                                @csrf
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="input"
                                                            value="{{ $client->fullname }}" name="fullname" required>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col">
                                                            <div class="form-group">
                                                        ...
                                                        <div class="col">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" name="area_id">
                                                                    ...
                                                                    @foreach ($ars as $ar)
                                                                        <option value="{{ $ar->id }}"
                                                                            @if ($ar->id == $client->area_id) selected @endif>
                                                                            {{ $ar->name }}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control" type="input"
                                                                    value="{{ $client->street }}" name="street">
                                                            </div>
                                                        </div>
                                                        <div class="col">
                                                            <div class="form-group">
                                                                <button type="button" class="btn btn-warning"
                                                                    ...
                                                                    id="select_location{{ $client->id }}"
                                                                    style="margin-top: 20px">
                                                                    <i class="fa fa-map-marker"></i> Lokatsiya</button>
                                                                <input type="hidden" onchange="dotReplace(event)"
                                                                    value="0" class="form-control"
                                                                    id="location{{ $client->id }}" name="location">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control" type="input"
                                                                    value="{{ $client->entrance }}" name="entrance">
                                                            </div>
                                                        </div>
                                                        <div class="col">
                                                            <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control phone-number" type="input"
                                                                    value="{{ $client->phone2 }}" name="phone2">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control" type="input"
                                                                    value="{{ $client->login }}" name="login" required>
                                                            </div>
                                                        </div>
                                                        <div class="col">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control" type="input"
                                                                    value="{{ $client->password }}" name="password"
                                                                    required>
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <div class="modal fade" id="delclient{{ $client->id }}" tabindex="-1"
                                    role="dialog">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <form action="{{ route('delete_client', ['id' => $client->id]) }}"
                                                method="post">
                                                @csrf
                                                <div class="modal-body">
                    ...
                    <form action="{{ route('clients') }}" method="get">
                        <div class="col d-flex justify-content mt-3">
                            <input type="number" class="form-control" name="page"
                                value="{{ request()->query('page') }}" placeholder="Page ...">
                            <select name="select_paginate" id="select_paginate" class="form-control ml-4">
