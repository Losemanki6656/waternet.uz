                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                            @if ($client->updated_at->diffInDays() > 14)
                                                <div class="bg-danger text-white" data-toggle="tooltip" data-placement="bottom" title="{{$client->updated_at->diffInDays() + 1}} kun davomida aktiv emas">{{$client->updated_at->format('d-m-Y')}}</div>
                                            @else 
                                                @if ($client->updated_at->diffInDays() >= 7 && $client->updated_at->diffInDays() <= 14)
                                                    <div class="bg-warning text-dark" data-toggle="tooltip" data-placement="bottom" title="{{$client->updated_at->diffInDays() + 1}} kun davomida aktiv emas"> {{$client->updated_at->format('d-m-Y')}}</div>    
                                                @else
                                                    <div class="bg-success text-white" data-toggle="tooltip" data-placement="bottom" title="{{$client->updated_at->diffInDays() + 1}} kun davomida aktiv emas">{{$client->updated_at->format('d-m-Y')}}</div>
                                                @endif        
                                            @endif
