            ...
            <div class="col-lg-7 col-md-12">
                <div class="card">
                    <ul class="nav nav-tabs">
                        <li class="nav-item"><a class="nav-link" href="{{ route('regions') }}"><i class="fa fa-home"></i>
                                Regionlar</a></li>
                        <li class="nav-item"><a class="nav-link active show" href="{{ route('cities') }}"><i
                                    class="fa fa-user"></i> Shaxarlar</a></li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane show active" id="Profile-withicon">
                            <div class="header">
                                ...
                                <button type="button" class="btn btn-danger" onclick="Sort()">
                                    <i class="fa fa-filter"></i> Mijozlar soni bo'yicha tartiblash
                                </button>
                                @push('scripts')
                                    <script>
                                        function Sort()
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="button" class="btn btn-dark" data-toggle="modal"
                                                            data-target="#edit{{ $area->id }}"><i
                                                                class="fa fa-edit"></i> <span></span></button>
                                                        <button type="button" class="btn btn-danger" data-toggle="modal"
                                                            data-target="#delete{{ $area->id }}"><i
                                                ...
                                                <div class="modal fade" id="delete{{ $area->id }}" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <form action="{{ route('delete_city', ['id' => $area->id]) }}"
                                                                method="post">
                                                                @csrf
                                                                <div class="modal-body">
                                                                    <div class="form-group">
                                                                        <h6><label>{{ $area->name }} shahrini o'chirishni
                                                                                xoxlaysizmi ?</label></h6>
                                                                    </div>
                                                                </div>
                                                                <div class="modal-footer">
