    ...
    <div class="container-fluid">
        ...
        <div class="card">   
            <ul class="nav nav-tabs">
                ...
                <li class="nav-item"><a class="nav-link" href="{{route('take_products')}}"><i class="fa fa-user"></i> Tovar chiqarish</a></li>
                <li class="nav-item"><a class="nav-link active show" href="{{route('entry_container')}}"><i class="fa fa-home"></i> Idishlarni kiritish</a></li>
                                    ...
                                    <form action="{{route('add_entry_container')}}" method="post">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="number" name="container_count" placeholder="Soni..." required>
                                            </div> 
                                        </div>
                                ...
                                <tbody>
                                    @foreach ($entrycontainer as $entrycon)
                                        <tr>                
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-outline-secondary" data-toggle="modal" data-target="#edit{{$entrycon->id}}">
                                                    <i class="fa fa-edit"></i> <span></span></button>
                                                <button type="button" class="btn btn-outline-danger" data-toggle="modal" data-target="#delete{{$entrycon->id}}"><i class="fa fa-trash-o"></i> <span></span></button>
                                            </td>
                                        </tr> 
                                        <div class="modal fade" id="edit{{$entrycon->id}}" tabindex="-1" role="dialog">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h4 class="title" id="defaultModalLabel">Taxrirlash</h4>
                                                    </div>
                                                    <form action="{{route('edit_entry_container',['id' => $entrycon->id])}}" method="post">
                                                        @csrf
                                                        <div class="modal-body">  
                                                            <div class="form-group">
                                                                <h6><label>Kimdan:</label></h6>
                                                            ...
                                                            <div class="form-group">
                                                                <h6><label>Soni:</label></h6>
                                                                <input class="form-control" type="number" value="{{$entrycon->product_count}}" name="container_count"  required>
                                                            </div> 
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-danger" data-dismiss="modal"> Chiqish</button>
                                        ...
                                        <div class="modal fade" id="delete{{$entrycon->id}}" tabindex="-1" role="dialog">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h4 class="title" id="defaultModalLabel">O'chirish</h4>
                                                    </div>
                                                    <form action="{{route('delete_entry_container',['id' => $entrycon->id])}}" method="post">
                                                        @csrf
                                                        <div class="modal-body">  
                                                            <div class="form-group">
