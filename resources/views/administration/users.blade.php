                ...
                @foreach ($data as $user)
                    <tr class="border-bottom border-200">
                        ...
                        <td class="text-center">
                            ...
                            <td class="text-center">
                                <div>
                                    <a href="{{ route('users.edit',$user->id) }}" class="btn btn-outline-dark" type="button"><i class="fa fa-edit"></i>
                                    </a>
                                    <button type="button" class="btn btn-outline-danger" type="button"><i class="fa fa-trash" data-toggle="modal" data-target="#deluser{{$user->id}}"></i>
                                    </button>
