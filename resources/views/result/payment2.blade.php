...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">{{ __('messages.payment_card') }}</h4>
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">{{ __('messages.payment_card') }}</li>
                    </ol>
                </div>
    ...
    <div class="card rounded-4">
        <div class="card-header">
            <h5>{{ __('messages.payment_card_in_the_period') }}: <span class="text-primary">{{ request('date1') }}</span> --
