...
<head>
    ...
    <meta charset="utf-8" />
    <title>Waternet: Login</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="Waternet" name="description" />
                            ...
                            <div class="d-flex flex-column h-100">
                                <div class="mb-4 mb-md-5 text-center">
                                    <a href="{{route('login')}}" class="d-block auth-logo">
                                        <img src="{{asset('assets/images/favicon.png')}}" alt="" height="28"> <span
                                            class="logo-txt">waternet</span>
                                    </a>
                                </div>
