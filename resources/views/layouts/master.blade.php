                        ...
                        <li>
                            <form id="navbar-search" class="navbar-form search-form" method="get">
                                ...
                                <input name="search" class="form-control" placeholder="Search here..."
                                    value="{{ request()->query('search') }}" type="text">
                        ...
                        <li>
                            <div id="navbar-menu">
                                <ul class="nav navbar-nav">
                                    <li>
                                        <a href="javascript:void(0);" class="mega_menu icon-menu"
                                            title="Mega Menu">Mega</a>
                                    </li>
                                    @if (Auth::user()->id != 1)
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu animated bounceIn notifications">
                                                <li class="header">
                                                    ...
                                                    <p>
                                                        <code class="text-white">{{ $info_org->date_traffic }}
                                                            gacha</code>
                                                    </p>
                                                </li>
                                                    ...
                                                    <a href="javascript:void(0);">
                                                        <div class="media">
                                                            ...
                                                            <div class="media-body">
                                                                <p class="text">Mijozlar soni: <strong>
                                                                        {{ $info_org->clients_count }} ta
                                                                        mavjud</strong></p>
                                                                <span class="timestamp">Tarif bo'yicha:
                                                                    {{ $info_org->traffic->clients_count }} ta</span>
                                                            </div>
                                                        </div>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0);">
                                                        <div class="media">
                                                            ...
                                                            <div class="media-body">
                                                                <p class="text">Smslar soni: <strong>
                                                                        {{ $info_org->sms_count }} ta
                                                                        yuborilgan</strong></p>
                                                                <span class="timestamp">Tarif bo'yicha:
                                                                    {{ $info_org->traffic->sms_count + $info_org->location }}
                                                                    ta</span>
                                                            </div>
                                                        </div>
                                                    </a>
                                                ...
                                                <li>
                                                    <a href="javascript:void(0);">
                                                        <div class="media">
                                                            ...
                                                            <div class="media-body">
                                                                <p class="text">Tovarlar soni: <strong>
                                                                        {{ $info_org->products_count }} ta
                                                                        mavjud</strong></p>
                                                                <span class="timestamp">Tarif bo'yicha:
                                                                    {{ $info_org->traffic->products_count }} ta</span>
                                                            </div>
                                                        </div>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0);">
                                                        <div class="media">
                                                            ...
                                                            <div class="media-body">
                                                                <p class="text">Xodimlar soni: <strong>
                                                                        {{ $info_org->users_count }} ta mavjud</strong>
                                                                </p>
                                                                <span class="timestamp">Tarif bo'yicha:
                                                                    {{ $info_org->traffic->users_count }} ta</span>
                                                            </div>
                                                        </div>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0);">
                                                        <div class="media">
                                                            ...
                                                            <div class="media-body">
                                                                <p class="text">Balans: <strong>
                                                                        {{ $info_org->balance }} so'm</strong></p>
                                                            </div>
                                                        </div>
                                                    </a>
                                                </li>
                                                <li class="footer"><a href="{{ route('traffic_merchant') }}"
                                                        class="more">Tarifni o'zgartirish</a></li>
                                            </ul>
                                        </li>
                                    @endif
                    ...
                    <ul id="main-menu" class="metismenu">
                        ...
                        @can('results')
                            <li class="{{ url()->current() == route('results') ? 'active' : '' }}">
                                <a href="{{ route('results') }}"><i
                                        class="fa fa-check-circle"></i><span>Hisobotlar</span>
                                </a>
                            </li>
                        @endcan
                        @can('sklad')
                        ...
                        <li class="{{ strpos(url()->current(), 'admin-traffics') ? 'active' : '' }}">
                            <a href="{{ route('admin_traffics') }}"><i
                                    class="fa fa-warning"></i><span>Tariflar</span>
                            </a>
                        </li>
                        @can('admin')
                            ...
                            <li class="{{ strpos(url()->current(), 'organization-app') ? 'active' : '' }}">
                                <a href="{{ route('organization_app') }}"><i class="fa fa-users"></i><span>App
                                        Orgnization Swipers</span>
                                </a>
                            </li>

                            <li class="{{ strpos(url()->current(), 'admin-app-cart') ? 'active' : '' }}">
                                <a href="{{ route('organization_app_cart') }}"><i class="fa fa-users"></i><span>App
                                        Orgnization Swipers</span>
                                </a>
                            </li>
                        @endcan
