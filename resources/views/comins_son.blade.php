...
<head>
    ...
    <meta charset="utf-8" />
    <title>Coming Soon | Dason - Admin & Dashboard Template</title>
                        ...
                        <div class="mb-5">
                            <a href="index.html">
                                <img src="assets/images/logo-sm.svg" alt="" height="30" class="me-1"><span
                                    class="logo-txt text-white font-size-22">Dason</span>
                            </a>
                        </div>
                        <h3 class="text-white mt-5">Let's get started with Dason</h3>
                        <p class="text-white-50 font-size-15">Donec pede justo fringilla vel aliquet nec vulputate eget
